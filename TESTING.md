...
| N9 | D | Profiling scene, channel source on Ramp, `universes = 4`, manager strobe left on Static. `Log Decoded Fixture Light Data` three or four times | Fixtures whose strobe channel is at or below 0.2 are **never** dimmed: under Ramp that is (000)-(003), (019)-(022) and (039)-(042), twelve of the fifty, and they must show non-zero intensity in every sample. The other 38 must show `intensity=0 active=0` in at least one sample, because the square wave is off for half its period. No timing precision is needed, only repetition |
