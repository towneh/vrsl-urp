...
{    
    ...
    public class VRSL_LocalUIControlPanel : MonoBehaviour
    {
       ...
       public bool sperateInGameInterpolationSpeed = true;
        ...
        int _VRSLU_DMXGridRenderTexture, _VRSLU_DMXGridRenderTextureMovement, _VRSLU_DMXGridSpinTimer, _VRSLU_DMXGridStrobeTimer, _VRSLU_DMXGridStrobeOutput;
        ...
        void _SetTextureIDS()
        {
            _VRSLU_DMXGridRenderTexture = PropertyToID("_VRSLU_DMXGridRenderTexture");
            _VRSLU_DMXGridRenderTextureMovement = PropertyToID("_VRSLU_DMXGridRenderTextureMovement");
            _VRSLU_DMXGridSpinTimer = PropertyToID("_VRSLU_DMXGridSpinTimer");
            _VRSLU_DMXGridStrobeTimer = PropertyToID("_VRSLU_DMXGridStrobeTimer");
            _VRSLU_DMXGridStrobeOutput = PropertyToID("_VRSLU_DMXGridStrobeOutput");
        }
        ...
        void EnableCRTS(CustomRenderTexture[] rtArray)
        {
            foreach(CustomRenderTexture rt in rtArray)
            {
                ...
                if(rt.name.Contains("Color"))
                {
                    ...
                    Shader.SetGlobalTexture(_VRSLU_DMXGridRenderTexture, rt, RenderTextureSubElement.Default);
                }
                else if(rt.name.Contains("Movement"))
                {
                    if(outputDebugLogs){
                        Debug.Log("DMX Movement: " + rt.name);}
                    Shader.SetGlobalTexture(_VRSLU_DMXGridRenderTextureMovement, rt, RenderTextureSubElement.Default);
                }
                else if(rt.name.Contains("Spin"))
                {
                    if(outputDebugLogs){
                        Debug.Log("DMX Spin Timings: " + rt.name);}
                    Shader.SetGlobalTexture(_VRSLU_DMXGridSpinTimer, rt, RenderTextureSubElement.Default);
                }
                else if(rt.name.Contains("Strobe"))
                {
                    if(rt.name.Contains("Timings"))
                    {
                        ...
                        Shader.SetGlobalTexture(_VRSLU_DMXGridStrobeTimer, rt, RenderTextureSubElement.Default);
                    }
                    else
                    {
                        ...
                        if(delayStrobeForGI)
                        {
                            ...
                            {
                                Shader.SetGlobalTexture(_VRSLU_DMXGridStrobeOutput, rt, RenderTextureSubElement.Default);
                            }
