Shader "VRSL-URP/Other/Discoball"
 {
     Properties
     {
         ...
         Pass
         {
			...
			#include "../Shared/VRSL-DMXFunctions.cginc"
             ...
             v2f vert(appdata v)
             {
                 ...
                 o.dmxIntensity = IF(_EnableCompatibilityMode == 1, float2(dmx, getValueAtCoords(dmx, _VRSLU_DMXGridRenderTexture)), float2(dmx, getValueAtCoords(dmx, _VRSLU_DMXGridRenderTexture)));
