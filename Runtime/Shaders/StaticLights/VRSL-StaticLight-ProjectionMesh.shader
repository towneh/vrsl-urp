Shader "VRSL-URP/Standard Static/Projection"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                #ifdef _CHANNEL_MODE
			        o.intensityStrobe = float2(getValueAtCoords(dmx, _VRSLU_DMXGridRenderTexture),GetStrobeOutputFiveCH(dmx));
			        o.rgbColor = float4(getValueAtCoords(dmx+1, _VRSLU_DMXGridRenderTexture), getValueAtCoords(dmx+2, _VRSLU_DMXGridRenderTexture), getValueAtCoords(dmx+3, _VRSLU_DMXGridRenderTexture), 1);
